        ...
        >
          <div className="sidebar-header pb-4 pt-2">
            <div className="d-flex px-4">
              <img
                src="images/default/user2.jpg"
                className="rounded-circle sidebar-image my-auto"
              ></img>
              <div className="my-auto">
                <h6
                  style={{ lineHeight: "12px", fontWeight: 600 }}
          ...
          <ul className="sidebar">
            <li
              className="listitem"
              className={`listitem ${active == "users" && "active_category"}`}
            >
            ...
            <li
              className="listitem"
              className={`listitem ${
                active == "managers" && "active_category"
              }`}
            >
            ...
            <Link to="/admin/category">
              <li
                className={`listitem ${
                  active == "categories" && "active_category"
                }`}
              >
                <h6
