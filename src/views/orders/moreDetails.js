                 ...
                 <div className="row">
                     <div className="col-8">
                        <h5 className="text-dark bold-normal py-2 bg-white shadow-sm px-2 mt-3 rounded">
                            Order Details {!deleteRequest ? null : <span className="badge badge-danger">User has requested to cansel this order</span>}
                        </h5>
                            ...
                            <div className="row">        
                                ...
                                <div className="col-md-12 mb-4">
                                    <h6 className="form-label py-2">Shipped</h6>
                                        <select className="form-control" value={shipped} name="shipped" onChange={ (e) => this.formValueChange(e)}>
